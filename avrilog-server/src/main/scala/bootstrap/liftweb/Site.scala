...
object Site extends Locs {
  ...
  val home = MenuLoc(Menu.i("Home") / "index" >> TopBarGroup >> RequireLoggedIn)
  ...
  private val profileParamMenu = Menu.param[User]("User", "Profile",
    ...
    _.username.is
  ) / "user" >> RequireLoggedIn >> Loc.CalcValue(() => User.currentUser)
  ...
  private def menus = List(
    ...
    password.menu,
    editProfile.menu,
    Menu.i("Application") / "application" / ** >> RequireLoggedIn,
